...
class ConnectionThread(threading.Thread):
    ...
    def search(self, for_user):
        query = f'SELECT username, first_name, last_name, email, gender, dob FROM {sql_table} WHERE username LIKE "{for_user}%"'
        self.cursor.execute(query)
        fetch = self.cursor.fetchall()
